...
const OpsRecord = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://localhost:5000/api/opsrecord');
    ...
    const handleSaveEditedData = async (index) => {
        try {
            ...
            await axios.post('http://localhost:5000/api/update-opsdata', editedData);
